...
CELFHeaderView::CELFHeaderView(HWND hParent, CELF* pELF)
{
	...
	m_pMachine	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pVersion	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pEntry	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pPHOffset	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pPHSize	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pPHCount	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pSHOffset	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pSHSize	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pSHCount	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pFlags	= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pSize		= new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	m_pSHStrTab = new CEdit(m_hWnd, &rc, _X(""), ES_READONLY);
	...
	m_pLayout->SetObject(0,  1, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Machine:"))));
	m_pLayout->SetObject(0,  2, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Version:"))));
	m_pLayout->SetObject(0,  3, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Entry Point:"))));
	m_pLayout->SetObject(0,  4, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Flags:"))));
	m_pLayout->SetObject(0,  5, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Header Size:"))));
	m_pLayout->SetObject(0,  6, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Program Header Table Offset:"))));
	m_pLayout->SetObject(0,  7, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Program Header Size:"))));
	m_pLayout->SetObject(0,  8, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Program Header Count:"))));
	m_pLayout->SetObject(0,  9, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Section Header Table Offset:"))));
	m_pLayout->SetObject(0, 10, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Section Header Size:"))));
	m_pLayout->SetObject(0, 11, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Section Header Count:"))));
	m_pLayout->SetObject(0, 12, CLayoutWindow::CreateTextBoxBehavior(100, 20, new CStatic(m_hWnd, _X("Section Header String Table Index:"))));
