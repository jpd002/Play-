...
BINDINGTARGET CInputProviderEmscripten::MakeBindingTarget(const EM_UTF8* code)
{
	...
	else if(!strcmp(code, "KeyF")) keyCode = INPUT_KEY_F;
	else if(!strcmp(code, "KeyG")) keyCode = INPUT_KEY_G;
	else if(!strcmp(code, "KeyH")) keyCode = INPUT_KEY_H;
	else if(!strcmp(code, "KeyI")) keyCode = INPUT_KEY_I;
	else if(!strcmp(code, "KeyJ")) keyCode = INPUT_KEY_J;
	else if(!strcmp(code, "KeyK")) keyCode = INPUT_KEY_K;
	else if(!strcmp(code, "KeyL")) keyCode = INPUT_KEY_L;
	else if(!strcmp(code, "KeyS")) keyCode = INPUT_KEY_S;
	else if(!strcmp(code, "KeyT")) keyCode = INPUT_KEY_T;
	else if(!strcmp(code, "KeyX")) keyCode = INPUT_KEY_X;
	else if(!strcmp(code, "KeyZ")) keyCode = INPUT_KEY_Z;
	else if(!strcmp(code, "Key0")) keyCode = INPUT_KEY_0;
	else if(!strcmp(code, "Key1")) keyCode = INPUT_KEY_1;
	else if(!strcmp(code, "Key2")) keyCode = INPUT_KEY_2;
	else if(!strcmp(code, "Key3")) keyCode = INPUT_KEY_3;
	else if(!strcmp(code, "Key8")) keyCode = INPUT_KEY_8;
	else if(!strcmp(code, "Key9")) keyCode = INPUT_KEY_9;
	else keyCode = code[0];
