...
#define PREF_PS2_MASS_DIRECTORY_DEFAULT ("vfs/mass")
    ...
    , m_otherProfilerZone(CProfiler::GetInstance().RegisterZone("OTHER"))
{
	...
	static const std::pair<const char*, const char*> basicDirectorySettings[] =
	{
		...
		std::make_pair(PREF_PS2_MASS_DIRECTORY, PREF_PS2_MASS_DIRECTORY_DEFAULT),
	};
	// clang-format on
...
void CPS2VM::ResetVM()
{
 ...
 iopOs->GetIoman()->RegisterDevice("mass", std::make_shared<Iop::Ioman::CPreferenceDirectoryDevice>(PREF_PS2_MASS_DIRECTORY))
