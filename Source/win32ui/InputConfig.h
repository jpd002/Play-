...
public:
	...
	typedef std::function<void (PS2::CControllerInfo::BUTTON, uint32)> InputEventHandler;
	...
	std::tstring			GetBindingDescription(Framework::DirectInput::CManager*, PS2::CControllerInfo::BUTTON) const;
