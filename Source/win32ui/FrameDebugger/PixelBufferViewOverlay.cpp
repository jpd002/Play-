...
{
	Create(0, Framework::Win32::CDefaultWndClass::GetName(), _T(""), WNDSTYLE, Framework::Win32::CRect(0, 0, 64, 32), parentWnd, nullptr);
	SetClassPtr();

	m_saveButton = std::make_unique<Framework::Win32::CButton>(_T("Save"), m_hWnd, Framework::Win32::CRect(0, 0, 32, 32));
	m_fitButton = std::make_unique<Framework::Win32::CButton>(_T("Fit"), m_hWnd, Framework::Win32::CRect(32, 0, 64, 32));
}
