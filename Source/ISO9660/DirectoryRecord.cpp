...
uint8 CDirectoryRecord::GetLength()
{
	return m_nLength;
}

bool CDirectoryRecord::IsDirectory()
{
	return (m_nFlags & 0x02) != 0;
}

const char* CDirectoryRecord::GetName()
{
	return m_sName;
}

uint32 CDirectoryRecord::GetPosition()
{
	return m_nPosition;
}

uint32 CDirectoryRecord::GetDataLength()
{
