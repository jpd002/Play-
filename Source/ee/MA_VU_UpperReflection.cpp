...
{
	//0x00
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	//0x08
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	//0x10
	...
	{	"MINI",		NULL,			ReflOpAffWrFdRdFsFt	},
	//0x18
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsQ	},
	{	"MAX",		NULL,			ReflOpAffWrFdRdFsI	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsI	},
	{	"MINI",		NULL,			ReflOpAffWrFdRdFsI	},
	//0x20
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsQ	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsQ	},
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsI	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsI	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsQ	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsQ	},
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsI	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsI	},
	//0x28
	{	"ADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MADD",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MUL",		NULL,			ReflOpAffWrFdRdFsFt	},
	...
	{	"SUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MSUB",		NULL,			ReflOpAffWrFdRdFsFt	},
	{	"OPMSUB",	NULL,			ReflOpAffWrFdRdFsFt	},
	{	"MINI",		NULL,			ReflOpAffWrFdRdFsFt	},
	//0x30
	{	NULL,		NULL,			NULL				},
	{	NULL,		NULL,			NULL				},
...
{
	//0x00
	{	"ADDA",		NULL,			ReflOpAffWrARdFsFt	},
	{	"SUBA",		NULL,			ReflOpAffWrARdFsFt	},
	{	"MADDA",	NULL,			ReflOpAffWrARdFsFt	},
...
VUINSTRUCTION CMA_VU::CUpper::m_cVuReflVX2[32] =
{
	...
	{	"MULA",		NULL,			ReflOpAffWrARdFsFtBc},
	{	"MULA",		NULL,			ReflOpAffWrARdFsI	},
	//0x08
	{	"ADDA",		NULL,			ReflOpAffWrARdFsI	},
	{	"SUBA",		NULL,			ReflOpAffWrARdFsI	},
	{	"MULA",		NULL,			ReflOpAffWrARdFsFt	},
	{	"OPMULA",	NULL,			ReflOpAffWrARdFsFt	},
	{	NULL,		NULL,			NULL				},
	{	NULL,		NULL,			NULL				},
	{	NULL,		NULL,			NULL				},
	{	NULL,		NULL,			NULL				},
...
VUINSTRUCTION CMA_VU::CUpper::m_cVuReflVX3[32] =
{
	...
	//0x08
	{	"MADDA",	NULL,			ReflOpAffWrARdFsI	},
	{	"MSUBA",	NULL,			ReflOpAffWrARdFsI	},
	{	NULL,		NULL,			NULL				},
