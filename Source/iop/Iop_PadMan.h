...
namespace Iop
{
	...
	template <> inline void CPadMan::CPadDataHandler<CPadMan::PADDATA>::SetNumberOfModes(unsigned int) {}

	template <> inline void CPadMan::CPadDataHandler<CPadMan::PADDATA80>::SetModeCurId(unsigned int) {}
	template <> inline void CPadMan::CPadDataHandler<CPadMan::PADDATA80>::SetModeCurOffset(unsigned int) {}
