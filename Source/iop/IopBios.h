...
public:
	...
	enum THREAD_STATUS
	{
		...
		THREAD_STATUS_WAITING_SEMAPHORE,
		THREAD_STATUS_WAITING_EVENTFLAG,
		THREAD_STATUS_WAITING_MESSAGEBOX,
		THREAD_STATUS_WAITING_FPL,
		THREAD_STATUS_WAIT_VBLANK_START,
		THREAD_STATUS_WAIT_VBLANK_END,
		THREAD_STATUS_WAIT_CDSYNC,
	};
