...
CUnknown2::CUnknown2(CSifMan& sif)
{
...
void CUnknown2::SaveState(Framework::CZipArchiveWriter& archive)
{	

}

void CUnknown2::LoadState(Framework::CZipArchiveReader& archive)
{
