...
m_thread(bind(&CPsfVm::ThreadProc, this))
{
    //IOP context setup
    {
		...
		m_cpu.m_pMemoryMap->InsertReadMap(Psx::CRootCounters::ADDR_BEGIN,	Psx::CRootCounters::ADDR_END,	bind(&Psx::CRootCounters::ReadRegister, &m_counters, _1),	0x03);
        m_cpu.m_pMemoryMap->InsertReadMap(CSpu2::REGS_BEGIN,				CSpu2::REGS_END,				bind(&CSpu2::ReadRegister, &m_spu, _1),						0x04);
		...
		m_cpu.m_pMemoryMap->InsertWriteMap(Psx::CRootCounters::ADDR_BEGIN,	Psx::CRootCounters::ADDR_END,	bind(&Psx::CRootCounters::WriteRegister, &m_counters, _1, _2),	0x03);
		m_cpu.m_pMemoryMap->InsertWriteMap(CSpu2::REGS_BEGIN,				CSpu2::REGS_END,	    		bind(&CSpu2::WriteRegister, &m_spu, _1, _2),					0x04);
